...
class Feedback {
    ...
    public boolean setFeedback(TryJShellTool tool, ArgTokenizer at) {
        return new FormatSetter(tool, at).setFeedback();
    }

    public boolean setField(TryJShellTool tool, ArgTokenizer at) {
        return new FormatSetter(tool, at).setField();
    }

    public boolean setFormat(TryJShellTool tool, ArgTokenizer at) {
        return new FormatSetter(tool, at).setFormat();
    }

    public boolean setNewMode(TryJShellTool tool, ArgTokenizer at) {
        return new FormatSetter(tool, at).setNewMode();
    }

    public boolean setPrompt(TryJShellTool tool, ArgTokenizer at) {
        return new FormatSetter(tool, at).setPrompt();
    }

    public void printFeedbackHelp(TryJShellTool tool) {
        new FormatSetter(tool, null).printFeedbackHelp();
    }

    public void printFieldHelp(TryJShellTool tool) {
        new FormatSetter(tool, null).printFieldHelp();
    }

    public void printFormatHelp(TryJShellTool tool) {
        new FormatSetter(tool, null).printFormatHelp();
    }

    public void printNewModeHelp(TryJShellTool tool) {
        new FormatSetter(tool, null).printNewModeHelp();
    }

    public void printPromptHelp(TryJShellTool tool) {
    ...
    private class FormatSetter {
        ...
        private final TryJShellTool tool;
        boolean valid = true;
        ...
        FormatSetter(TryJShellTool tool, ArgTokenizer at) {
            this.tool = tool;
            this.at = at;
        }
